...
<DefinitionList>
  ...
  <dd>
    <ul>
      <li>am Laptop</li>
      <li>mehrheitlich praktische Aufgaben</li>
      <li>einzelne Theorie-Anwendungsaufgaben (ebenfalls am Laptop, mit denselben Hilfsmitteln)</li>
      <li>**Hinweis:** Für die Abgabe am Ende der Probe wird erwartet, dass Sie die Grundlagen zum Teilen von Dateien (ZIP-Datei erstellen, per Teams senden, per Mail senden, einen OneDrive-Ordner freigeben) aus dem BYOD-Basics-Block beherrschen. Es kann nur bewertet werden, was korrekt abgegeben wird.</li>
    </ul>
  </dd>
  ...
  <dd>
    <ul>
      <li>das gesamte Classrooms darf verwendet werden</li>
      <li>andere Hilfsmittel (Google, KI, eigene Dateien, Notizen ausserhalb von Classrooms, etc.) sind **nicht** erlaubt</li>
    </ul>
  </dd>

  <WithCmsText entries={{note: "70a11ee7-8b9c-43f5-9a84-bf3c2efc218f", punkte: "b41c4e62-590c-44e4-b137-d19d52f28fc8"}}>
    <dt>Note</dt>
    <dd>__<CmsText name="note" />__ (<CmsText name="punkte" />/32 Punkten)</dd>
  </WithCmsText>
</DefinitionList>
