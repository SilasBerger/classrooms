...
## Unterrichtsfolien
Die Unterrichtsfolien zu diesem Thema finden Sie [hier](https://erzbe-my.sharepoint.com/:f:/g/personal/silas_berger_gbsl_ch/EkedtpCJKdpEp1-1fVNrnq0BP3TLq016djA9bwPl3NSb8w?e=nqiLky).
...
<DefinitionList>
  ...
  <WithCmsText entries={{note: "b9dd8c01-8dce-4788-94dd-66046eb6d64a", punkte: "11e4ee3e-be56-445f-b9ad-df831be566de"}}>
    <dt>Note</dt>
    <dd>__<CmsText name="note" />__ (<CmsText name="punkte" />/24.5 Punkten)</dd>
  </WithCmsText>
</DefinitionList>
...
- Sie können begründen, weshalb eine Hashfiunktion nicht injektiv sein kann, und wissen, was die Konsequenz davon ist.
:::
