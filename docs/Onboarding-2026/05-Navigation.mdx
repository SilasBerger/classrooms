...
:::aufgabe[Suchen]
<TaskState id="67e41962-faee-4798-a86c-56589ac8c74f" />
Nutzen Sie die Suchfunktion, um herauszufinden, wie Sie bei IT-Problemen vorgehen müssen. Suchen Sie dazu in der Classrooms-Suche nach __IT-Probleme__, wählen Sie ein passendes Suchergebnis aus, und lesen Sie die ganze gefundene Seite sorgfältig durch.
...
Sobald Sie das Quiz **vollständig korrekt beantwortet** haben, können Sie diese Aufgabe als erledigt markieren.
:::
...
:::aufgabe[Was haben Sie gefunden?]
<TaskState id="318bbcec-e7bf-4c98-9575-3ebfa1c96ca7" />
