...
import { points } from '@tdev-components/documents/Assessable/helpers/scoring'
...
| **Integrität**      | Falls eine Nachricht auf dem Weg vom Sender zum Empfänger manipuliert wird, wollen wir dies entdecken können.   |
...
<Quiz keepExpanded="correct" scoring={points(1)} id="a9d0c9d5-ac63-4023-a3ee-d2d94c49e1dc">
    <ChoiceAnswer title="Fallbeispiel 1" correct={[3]}>
        ...
        <ChoiceAnswer title="Fallbeispiel 2" correct={[2]}>
        ...
        <ChoiceAnswer title="Fallbeispiel 3" correct={[1]}>
