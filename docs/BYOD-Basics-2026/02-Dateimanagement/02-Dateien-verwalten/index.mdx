...
<ChoiceAnswer multiple randomizeOptions correct={[1, 2, 3, 4]} keepExpanded={"correct"} id="982e5409-4b17-40e1-b7b7-6f10f1dc5c14">
...
<TrueFalseAnswer correct={false} keepExpanded={"correct"} id="6d42d70e-b58b-466b-8a07-0ac886b116af">
...
<OsTabs>
    <TabItem value="win">
        ...
        1. Erstellen Sie in Ihrer **Schul-OneDrive** in einem sinnvollen Ordner (z.B. `Informatik`) einen Ordner mit dem Namen `Übung Navigation Explorer`.
