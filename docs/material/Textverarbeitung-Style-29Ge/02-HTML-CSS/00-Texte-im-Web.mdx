---
page_id: 5f9fbd05-5211-4eed-856c-67ab2569516d
---
...
<br/>
Microsoft Word eignet sich nicht für die Erstellung eines Textes, der für das Web bestimmt ist. Wir verwenden stattdessen zwei formale Sprachen namens _HTML_ und _CSS_. In diesem Artikel lernen Sie, wieso das so ist, und was diese beiden Sprachen machen.
...
Eine Webseite gestalten wir deshalb nicht in einem Programm wie Word, das zu einem festgelegten Format zwingt. Stattdessen schreiben wir unseren Text in einem einfachen _Text- oder Code-Editor_ wie z.B. VSCode.

Nun bleibt aber noch die Frage: Wie können wir in VSCode unseren Text formatieren? Bei einer Webseite drücken wir dazu nicht auf einen Knopf, um z.B. die Schrift **fett** oder _kursiv_ zu machen. Stattdessen schreiben wir die Information zur Darstellung und Struktur einfach gleich direkt in den Text hinein. Statt unsere Überschrift `Hallo, Welt` zu markieren und dann auf die Formatvorlage _Titel_ klicken, schreiben wir davor `<h1>` und danach `</h1>` (vgl. Abbildung am Anfang dieser Seite). In VSCode ändert sich damit erstmal nichts an der Darstellung dieses Texts. Wenn aber nun ein Webbrowser diesen Text liest, dann weiss er, dass er `Hallo, Welt` als Überschrift (engl.: _heading 1_, Überschrift 1) darstellen soll.
...
Wenn wir aber in einem Text- oder Code-Editor wie VSCode eine Webseite gestalten, dann sehen wir dort erstmal nichts von der Darstellung, wie sie später im Browser aussehen wird. Was wir _\[im Editor]_ sehen, ist also nicht das, was wir _\[im Browser]_ bekommen.
